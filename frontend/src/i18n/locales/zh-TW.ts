export default {
  ...
  settings: {
    ...
    developerMode: "開發者模式",
    developerModeLabel: "啟用開發者模式",
    developerModeDescription: "在印表機卡片上加入診斷面板，並解鎖下方的串流傳輸方式覆寫選項。保持關閉也沒問題。",
    developerModeWarning: "開發者模式會顯示實驗性與診斷用的控制項。此處的覆寫會繞過通常正確的自動行為，可能造成串流品質下降、印表機額外負載，甚至攝影機無法運作。除非正在偵錯，否則請保持關閉；回報問題時請一併說明已啟用。",
    cameraTransport: "攝影機傳輸方式",
    cameraTransportAuto: "自動（建議）",
    cameraTransportMjpeg: "強制 MJPEG",
    cameraTransportMse: "強制 H.264 / MSE",
    cameraTransportDescription: "自動模式在印表機支援時使用 H.264 直通，否則回退為 MJPEG。若要比較，可強制指定傳輸方式。",
    devPerfOverlay: "打包與路由效能浮層",
    devPerfOverlayDescription: "浮動面板，顯示已載入的路由區塊、各自的大小，以及每個區塊的擷取與轉譯耗時。",
    devRawState: "印表機原始狀態檢視器",
    devRawStateDescription: "在診斷面板中加入印表機未解析的 MQTT 資料。便於回報錯誤。",
    devQueryDevtools: "查詢快取檢視器",
    devQueryDevtoolsDescription: "在浮層中新增「Queries」分頁，列出每個快取查詢及其狀態與過期程度。",
    devVerboseLogging: "詳細傳輸記錄",
    devVerboseLoggingDescription: "將攝影機與 websocket 的傳輸事件記錄到瀏覽器主控台。輸出量大屬正常設計。",
