export default {
  ...
  settings: {
    ...
    developerModeDescription: "Adds a diagnostics panel to printer cards and unlocks the stream transport override below. Safe to leave off.",
    developerModeWarning: "Developer mode exposes experimental and diagnostic controls. Overrides here can degrade streaming, put extra load on your printer, or stop the camera working — they bypass the automatic behaviour that is normally correct. Leave it off unless you are debugging, and mention it when reporting a bug.",
    cameraTransport: "Camera transport",
    cameraTransportAuto: "Auto (recommended)",
    cameraTransportMjpeg: "Force MJPEG",
    cameraTransportMse: "Force H.264 / MSE",
    cameraTransportDescription: "Auto picks H.264 passthrough where the printer supports it and falls back to MJPEG. Force a transport to A/B them.",
    devPerfOverlay: "Bundle & route performance overlay",
    devPerfOverlayDescription: "Floating panel showing which route chunks have loaded, their size, and how long each took to fetch and render.",
    devRawState: "Raw printer state inspector",
    devRawStateDescription: "Adds the unparsed MQTT payload for a printer to its diagnostics panel. Useful for reporting bugs.",
    devQueryDevtools: "Query cache inspector",
    devQueryDevtoolsDescription: "Adds a Queries tab to the overlay listing every cached query, its status, and how stale it is.",
    devVerboseLogging: "Verbose transport logging",
    devVerboseLoggingDescription: "Logs camera and websocket transport events to the browser console. Noisy by design.",
