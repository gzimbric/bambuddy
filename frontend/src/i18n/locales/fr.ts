export default {
  ...
  settings: {
    ...
    developerMode: "Mode développeur",
    developerModeLabel: "Activer le mode développeur",
    developerModeDescription: "Ajoute un panneau de diagnostic aux cartes d'imprimante et débloque le forçage du transport vidéo ci-dessous. Peut rester désactivé sans souci.",
    developerModeWarning: "Le mode développeur expose des contrôles expérimentaux et de diagnostic. Les forçages peuvent dégrader le flux, surcharger l'imprimante ou empêcher la caméra de fonctionner : ils contournent le comportement automatique, normalement correct. Laissez-le désactivé sauf en cas de débogage, et signalez-le dans vos rapports de bug.",
    cameraTransport: "Transport de la caméra",
    cameraTransportAuto: "Automatique (recommandé)",
    cameraTransportMjpeg: "Forcer MJPEG",
    cameraTransportMse: "Forcer H.264 / MSE",
    cameraTransportDescription: "Automatique choisit le passthrough H.264 quand l'imprimante le permet, sinon MJPEG. Forcez un transport pour les comparer.",
    devPerfOverlay: "Superposition de performance des bundles et des routes",
    devPerfOverlayDescription: "Panneau flottant indiquant quels fragments de route ont été chargés, leur taille et le temps de téléchargement et de rendu de chacun.",
    devRawState: "Inspecteur d'état brut de l'imprimante",
    devRawStateDescription: "Ajoute la charge utile MQTT brute de l'imprimante à son panneau de diagnostic. Utile pour signaler un bogue.",
    devQueryDevtools: "Inspecteur du cache de requêtes",
    devQueryDevtoolsDescription: "Ajoute un onglet « Queries » à la superposition, listant chaque requête en cache, son état et son obsolescence.",
    devVerboseLogging: "Journalisation détaillée du transport",
    devVerboseLoggingDescription: "Consigne les événements de transport de la caméra et du websocket dans la console du navigateur. Volontairement verbeux.",
