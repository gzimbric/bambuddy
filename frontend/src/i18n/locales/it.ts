export default {
  ...
  settings: {
    ...
    developerMode: "Modalità sviluppatore",
    developerModeLabel: "Attiva la modalità sviluppatore",
    developerModeDescription: "Aggiunge un pannello diagnostico alle schede stampante e sblocca la forzatura del trasporto video qui sotto. Può restare disattivata senza problemi.",
    developerModeWarning: "La modalità sviluppatore espone controlli sperimentali e diagnostici. Le forzature possono peggiorare lo streaming, caricare ulteriormente la stampante o bloccare la videocamera, perché aggirano il comportamento automatico normalmente corretto. Lasciala disattivata se non stai eseguendo il debug e segnalala quando apri una segnalazione.",
    cameraTransport: "Trasporto videocamera",
    cameraTransportAuto: "Automatico (consigliato)",
    cameraTransportMjpeg: "Forza MJPEG",
    cameraTransportMse: "Forza H.264 / MSE",
    cameraTransportDescription: "Automatico usa il passthrough H.264 dove la stampante lo supporta e ripiega su MJPEG. Forza un trasporto per confrontarli.",
    devPerfOverlay: "Overlay prestazioni bundle e route",
    devPerfOverlayDescription: "Pannello flottante che mostra quali chunk di route sono stati caricati, la loro dimensione e quanto tempo ha richiesto il download e il rendering di ciascuno.",
    devRawState: "Ispettore dello stato grezzo della stampante",
    devRawStateDescription: "Aggiunge il payload MQTT non elaborato della stampante al suo pannello diagnostico. Utile per segnalare bug.",
    devQueryDevtools: "Ispettore della cache delle query",
    devQueryDevtoolsDescription: "Aggiunge all'overlay una scheda «Queries» che elenca ogni query in cache, il suo stato e quanto è obsoleta.",
    devVerboseLogging: "Log dettagliato del trasporto",
    devVerboseLoggingDescription: "Registra gli eventi di trasporto della fotocamera e del websocket nella console del browser. Volutamente prolisso.",
