export default {
  ...
  settings: {
    ...
    developerMode: "Geliştirici modu",
    developerModeLabel: "Geliştirici modunu etkinleştir",
    developerModeDescription: "Yazıcı kartlarına bir tanılama paneli ekler ve aşağıdaki akış aktarım geçersiz kılmasını açar. Kapalı bırakılması sorun değildir.",
    developerModeWarning: "Geliştirici modu deneysel ve tanılama amaçlı denetimleri açığa çıkarır. Buradaki geçersiz kılmalar normalde doğru olan otomatik davranışı atladığı için akışı bozabilir, yazıcıya fazladan yük bindirebilir veya kamerayı çalışmaz hale getirebilir. Hata ayıklamıyorsanız kapalı bırakın ve hata bildirirken bundan söz edin.",
    cameraTransport: "Kamera aktarımı",
    cameraTransportAuto: "Otomatik (önerilen)",
    cameraTransportMjpeg: "MJPEG'i zorla",
    cameraTransportMse: "H.264 / MSE'yi zorla",
    cameraTransportDescription: "Otomatik, yazıcı destekliyorsa H.264 doğrudan aktarımını kullanır, desteklemiyorsa MJPEG'e döner. Karşılaştırmak için bir aktarım türünü zorlayın.",
    devPerfOverlay: "Paket ve rota performans katmanı",
    devPerfOverlayDescription: "Hangi rota parçalarının yüklendiğini, boyutlarını ve her birinin indirilip işlenmesinin ne kadar sürdüğünü gösteren yüzen panel.",
    devRawState: "Ham yazıcı durumu denetleyicisi",
    devRawStateDescription: "Yazıcının işlenmemiş MQTT verisini tanılama paneline ekler. Hata bildirirken kullanışlıdır.",
    devQueryDevtools: "Sorgu önbelleği denetleyicisi",
    devQueryDevtoolsDescription: "Katmana, önbellekteki her sorguyu, durumunu ve ne kadar eskidiğini listeleyen bir «Queries» sekmesi ekler.",
    devVerboseLogging: "Ayrıntılı aktarım günlüğü",
    devVerboseLoggingDescription: "Kamera ve websocket aktarım olaylarını tarayıcı konsoluna kaydeder. Tasarımı gereği ayrıntılıdır.",
