export default {
  ...
  settings: {
    ...
    developerMode: "개발자 모드",
    developerModeLabel: "개발자 모드 사용",
    developerModeDescription: "프린터 카드에 진단 패널을 추가하고 아래의 스트림 전송 방식 재정의를 활성화합니다. 꺼두어도 괜찮습니다.",
    developerModeWarning: "개발자 모드는 실험적·진단용 컨트롤을 노출합니다. 여기의 재정의는 일반적으로 올바른 자동 동작을 우회하므로 스트리밍 품질 저하, 프린터 부하 증가, 카메라 중단을 일으킬 수 있습니다. 디버깅 중이 아니라면 꺼두고, 버그를 보고할 때 사용 여부를 알려주세요.",
    cameraTransport: "카메라 전송 방식",
    cameraTransportAuto: "자동(권장)",
    cameraTransportMjpeg: "MJPEG 강제",
    cameraTransportMse: "H.264 / MSE 강제",
    cameraTransportDescription: "자동은 프린터가 지원하면 H.264 패스스루를 사용하고, 아니면 MJPEG으로 대체합니다. 비교하려면 전송 방식을 강제하세요.",
    devPerfOverlay: "번들 및 라우트 성능 오버레이",
    devPerfOverlayDescription: "어떤 라우트 청크가 로드되었는지, 크기는 얼마인지, 가져오기와 렌더링에 얼마나 걸렸는지 보여주는 플로팅 패널입니다.",
    devRawState: "프린터 원시 상태 검사기",
    devRawStateDescription: "프린터의 가공되지 않은 MQTT 페이로드를 진단 패널에 추가합니다. 버그 신고에 유용합니다.",
    devQueryDevtools: "쿼리 캐시 검사기",
    devQueryDevtoolsDescription: "캐시된 모든 쿼리와 상태, 오래된 정도를 나열하는 'Queries' 탭을 오버레이에 추가합니다.",
    devVerboseLogging: "상세 전송 로깅",
    devVerboseLoggingDescription: "카메라와 웹소켓 전송 이벤트를 브라우저 콘솔에 기록합니다. 의도적으로 로그가 많습니다.",
