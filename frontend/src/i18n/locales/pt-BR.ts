export default {
  ...
  settings: {
    ...
    developerMode: "Modo desenvolvedor",
    developerModeLabel: "Ativar modo desenvolvedor",
    developerModeDescription: "Adiciona um painel de diagnóstico aos cartões de impressora e libera a substituição do transporte de vídeo abaixo. Pode ficar desativado tranquilamente.",
    developerModeWarning: "O modo desenvolvedor expõe controles experimentais e de diagnóstico. As substituições podem degradar a transmissão, sobrecarregar a impressora ou deixar a câmera sem funcionar, pois ignoram o comportamento automático que normalmente está correto. Deixe desativado a menos que esteja depurando e mencione ao relatar um problema.",
    cameraTransport: "Transporte da câmera",
    cameraTransportAuto: "Automático (recomendado)",
    cameraTransportMjpeg: "Forçar MJPEG",
    cameraTransportMse: "Forçar H.264 / MSE",
    cameraTransportDescription: "O automático usa passthrough H.264 quando a impressora suporta e recorre ao MJPEG. Force um transporte para compará-los.",
    devPerfOverlay: "Sobreposição de desempenho de bundles e rotas",
    devPerfOverlayDescription: "Painel flutuante que mostra quais fragmentos de rota foram carregados, seu tamanho e quanto tempo cada um levou para ser baixado e renderizado.",
    devRawState: "Inspetor de estado bruto da impressora",
    devRawStateDescription: "Adiciona o payload MQTT bruto da impressora ao seu painel de diagnóstico. Útil para relatar bugs.",
    devQueryDevtools: "Inspetor de cache de consultas",
    devQueryDevtoolsDescription: "Adiciona uma aba «Queries» à sobreposição listando cada consulta em cache, seu status e o quão desatualizada está.",
    devVerboseLogging: "Registro detalhado de transporte",
    devVerboseLoggingDescription: "Registra eventos de transporte da câmera e do websocket no console do navegador. Verboso por design.",
