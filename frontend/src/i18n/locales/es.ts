export default {
  ...
  settings: {
    ...
    developerMode: "Modo desarrollador",
    developerModeLabel: "Activar modo desarrollador",
    developerModeDescription: "Añade un panel de diagnóstico a las tarjetas de impresora y habilita la anulación del transporte de vídeo. Puede dejarse desactivado sin problema.",
    developerModeWarning: "El modo desarrollador expone controles experimentales y de diagnóstico. Las anulaciones pueden degradar la transmisión, sobrecargar la impresora o dejar la cámara sin funcionar, ya que omiten el comportamiento automático que normalmente es correcto. Déjelo desactivado salvo que esté depurando, y menciónelo al informar de un error.",
    cameraTransport: "Transporte de cámara",
    cameraTransportAuto: "Automático (recomendado)",
    cameraTransportMjpeg: "Forzar MJPEG",
    cameraTransportMse: "Forzar H.264 / MSE",
    cameraTransportDescription: "Automático usa paso directo H.264 cuando la impresora lo admite y recurre a MJPEG. Fuerce un transporte para compararlos.",
    devPerfOverlay: "Superposición de rendimiento de paquetes y rutas",
    devPerfOverlayDescription: "Panel flotante que muestra qué fragmentos de ruta se han cargado, su tamaño y cuánto tardó cada uno en descargarse y renderizarse.",
    devRawState: "Inspector de estado sin procesar de la impresora",
    devRawStateDescription: "Añade la carga útil MQTT sin procesar de la impresora a su panel de diagnóstico. Útil para informar de errores.",
    devQueryDevtools: "Inspector de caché de consultas",
    devQueryDevtoolsDescription: "Añade una pestaña «Queries» a la superposición que enumera cada consulta en caché, su estado y su antigüedad.",
    devVerboseLogging: "Registro detallado del transporte",
    devVerboseLoggingDescription: "Registra los eventos de transporte de la cámara y del websocket en la consola del navegador. Ruidoso a propósito.",
