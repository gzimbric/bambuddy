export default {
  ...
  settings: {
    ...
    developerMode: "Entwicklermodus",
    developerModeLabel: "Entwicklermodus aktivieren",
    developerModeDescription: "Fügt Druckerkarten ein Diagnosefeld hinzu und schaltet die Stream-Transport-Überschreibung unten frei. Kann bedenkenlos deaktiviert bleiben.",
    developerModeWarning: "Der Entwicklermodus macht experimentelle und diagnostische Steuerelemente zugänglich. Überschreibungen hier können das Streaming verschlechtern, den Drucker zusätzlich belasten oder die Kamera lahmlegen — sie umgehen das automatische Verhalten, das normalerweise korrekt ist. Lassen Sie ihn deaktiviert, sofern Sie nicht debuggen, und erwähnen Sie ihn bei Fehlerberichten.",
    cameraTransport: "Kamera-Transport",
    cameraTransportAuto: "Automatisch (empfohlen)",
    cameraTransportMjpeg: "MJPEG erzwingen",
    cameraTransportMse: "H.264 / MSE erzwingen",
    cameraTransportDescription: "Automatisch wählt H.264-Passthrough, wenn der Drucker es unterstützt, und fällt sonst auf MJPEG zurück. Erzwingen Sie einen Transport, um sie zu vergleichen.",
    devPerfOverlay: "Bundle- und Routen-Performance-Overlay",
    devPerfOverlayDescription: "Schwebendes Panel, das zeigt, welche Routen-Chunks geladen wurden, wie groß sie sind und wie lange Abruf und Rendern gedauert haben.",
    devRawState: "Rohdaten-Inspektor für den Druckerstatus",
    devRawStateDescription: "Fügt dem Diagnose-Panel die unverarbeitete MQTT-Nutzlast des Druckers hinzu. Nützlich für Fehlerberichte.",
    devQueryDevtools: "Query-Cache-Inspektor",
    devQueryDevtoolsDescription: "Fügt dem Overlay eine Registerkarte „Queries“ hinzu, die jede zwischengespeicherte Abfrage, ihren Status und ihre Aktualität auflistet.",
    devVerboseLogging: "Ausführliche Transport-Protokollierung",
    devVerboseLoggingDescription: "Protokolliert Kamera- und WebSocket-Transportereignisse in der Browser-Konsole. Absichtlich sehr gesprächig.",
